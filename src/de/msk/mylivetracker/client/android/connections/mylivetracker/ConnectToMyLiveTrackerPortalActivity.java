...
/**
 * ConnectToMyLiveTrackerPortalActivity.
 * 
 ...
 * 
 */
public class ConnectToMyLiveTrackerPortalActivity extends AbstractActivity {	
	
	private static final class OnClickButtonOkListener implements OnClickListener {
		private ConnectToMyLiveTrackerPortalActivity activity;
		...
		public OnClickButtonOkListener(
			ConnectToMyLiveTrackerPortalActivity activity,
		...
		public void onClick(View v) {
			...
			if (valid) {				
				...
				ConnectToMyLiveTrackerPortalTask connectToMyLiveTrackerTask = 
					new ConnectToMyLiveTrackerPortalTask(this.progressDialogHandler);
	...
	protected static class ResultDialog extends AbstractInfoDialog {
		...
		public ResultDialog(Context ctx, String message, 
			ConnectToMyLiveTrackerPortalActivity activity, boolean success) {
			super(ctx, message);
			this.activity = activity;
	...
	protected static class ProgressDialogHandler extends Handler {
		...
		public ProgressDialogHandler(ConnectToMyLiveTrackerPortalActivity activity) {
			this.activity = activity;			
		}
	...
	private static final class OnClickButtonCancelListener implements OnClickListener {
		...
		private OnClickButtonCancelListener(ConnectToMyLiveTrackerPortalActivity activity) {
			this.activity = activity;
		}
		/* (non-Javadoc)
